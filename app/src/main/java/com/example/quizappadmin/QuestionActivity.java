...
import com.example.quizappadmin.Adapters.QuestionsAdapter;
import com.example.quizappadmin.Models.QuestionModel;
import com.example.quizappadmin.databinding.ActivityQuestionBinding;
                        ...
                        .addValueEventListener(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot snapshot) {
                                ...
                                if(snapshot.exists()) {
                                    ...
                                    Toast.makeText(QuestionActivity.this,"No questions found\nStart by adding new questions!",Toast.LENGTH_SHORT).show();
                                }
                            }
