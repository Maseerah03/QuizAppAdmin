...
import com.example.quizappadmin.databinding.ActivityAddQuestionBinding;
                        ...
                        .addOnCompleteListener(new OnCompleteListener<Void>() {
                            ...
                            public void onComplete(@NonNull Task<Void> task) {
                                if (task.isSuccessful()) {
                                    ...
                                    ((EditText) binding.answerContainer.getChildAt(0)).setText("");
                                    ((EditText) binding.answerContainer.getChildAt(1)).setText("");
                                    ((EditText) binding.answerContainer.getChildAt(2)).setText("");
                                    ((EditText) binding.answerContainer.getChildAt(3)).setText("");
                                    // Clear radio button selection
                                    binding.optionContainer.clearCheck();
                                } else {
